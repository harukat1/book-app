<header>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1f1f1f;">
        <div class="container-fluid">
            @auth
                <a class="navbar-brand" href="{{ route('bookshelf.index') }}">学習管理</a>
            @else
                <a href="navbar-brand" href="/">学習管理</a>
            @endauth
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    @auth
                        <!-- <a class="mr-lg-3 my-lg-0 my-3 btn btn-sm btn-secondary text-light nav-item nav-link disabled" href="#">{{ Auth::user()->name }}</a> -->
                        <a class="mr-lg-3 my-lg-0 my-3 btn btn-sm btn-secondary text-light nav-item nav-link" href="{{ route('profile.edit') }}">{{ Auth::user()->name }}</a>
