...
@section('content')
    ...
    <ul class="nav nav-pills nav-justified">
        ...
        <li class="nav-item"><a class="nav-link active" href="{{ route('bookshelf.completed-book') }}">読み終わった本</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('bookshelf.reading-book') }}">学習中の本</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('bookshelf.standby-book') }}">これから学習する本</a></li>
    </ul>
